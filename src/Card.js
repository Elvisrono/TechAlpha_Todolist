        ...
        <div class = "card-wrapper mr-5">
            ...
            <div class = "task-holder">
                ...
                <div className='icons' style={{"position": "absolute", "right" : "20px", "bottom" : "20px"}}>
                    <TiEdit className='edit' onClick = {() => setModal(true)} />
                    <MdDelete className='delete' onClick = {handleDelete} />
                {/* <FaFontAwesome className='far fa-edit' style={{"color" : colors[index%5].primaryColor, "cursor" : "pointer"}} onClick = {() => setModal(true)} />
